...
public class MetaDataMongo {
    ...
    static final String SONG_ALBUM_ID = SONG_ALBUM_INFO + "." + ALBUM_ID;
    static final String SONG_ALBUM_NAME = SONG_ALBUM_INFO + "." + ALBUM_NAME;
    static final String SONG_ARTIST_INFO = "artistInfo";
    static final String SONG_ARTIST_ID = SONG_ARTIST_INFO + "." + ARTIST_ID;
    static final String SONG_ARTIST_NAME = SONG_ARTIST_INFO + "." + ARTIST_NAME;
